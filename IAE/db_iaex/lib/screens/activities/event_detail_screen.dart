    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        ...
        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          ...
          _detailCard(Icons.timer_off_outlined, 'Waktu Selesai', act.endTime != null && act.endTime!.isNotEmpty ? Formatters.formatTime(act.endTime) : '-', width: double.infinity),
          const SizedBox(height: 12),
          Row(children: [
          ...
          const SizedBox(height: 12),
          _detailCard(Icons.stadium_outlined, 'Gor', act.gor ?? '-', width: double.infinity),
          const SizedBox(height: 12),
