                  ...
                  Row(
                    children: [
                      ...
                      Container(
                        ...
                        decoration: BoxDecoration(
                          color: com.privacy == 'public' ? AppColors.success.withValues(alpha: 0.1) : AppColors.errorRed.withValues(alpha: 0.1),
                          borderRadius: BorderRadius.circular(9999),
                        ),
                        child: Text(
                          com.privacy.isNotEmpty ? '${com.privacy[0].toUpperCase()}${com.privacy.substring(1)}' : 'Public',
                          style: TextStyle(
                            fontSize: 11,
                            fontWeight: FontWeight.w600,
                            color: com.privacy == 'public' ? AppColors.success : AppColors.errorRed,
                          ),
                        ),
                      ),
                      const Spacer(),
