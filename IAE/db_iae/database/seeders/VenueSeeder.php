    ...
    public function run(): void
    {
        $venues = [
            ...
            [
                ...
                'location' => 'Jl. Letjen S. Parman No. 12, Slipi, Jakarta Barat',
            ...
            [
                'name' => 'Kemang Padel Paradise',
                'sport_type' => 'padel',
                'description' => 'Padel court premium dengan nuansa tropis di tengah kota Jakarta. Lapangan outdoor berkualitas tinggi dengan dinding kaca dan rumput sintetis Mondo.',
                'location' => 'Jl. Kemang Raya No. 99, Kemang, Jakarta Selatan',
            ...
            [
                'name' => 'Senayan Volley Arena',
                'sport_type' => 'volleyball',
                'description' => 'Arena voli bergengsi di Jakarta dengan 4 lapangan indoor full-size. Digunakan untuk Proliga dan event nasional. Fasilitas lengkap untuk atlet profesional dan komunitas.',
                'location' => 'Kawasan Gelora Bung Karno, Senayan, Jakarta Pusat',
