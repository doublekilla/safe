        ...
        <section className="bg-[#FFFFFF] py-16 px-4 sm:px-6 lg:px-8">
            <div className="max-w-4xl mx-auto">
                <div className="bg-gradient-primary rounded-[24px] p-10 md:p-16 text-center shadow-xl relative overflow-hidden">
                    ...
                    <h2 className="text-3xl md:text-4xl font-black text-white mb-4 relative z-10">Siap Main?</h2>
                    <p className="text-gray-300 text-lg mb-8 max-w-2xl mx-auto relative z-10 leading-relaxed">
                        Booking lapangan sekarang dan nikmati pengalaman olahraga terbaik di EithSpace.
                    </p>
                    <Link href={route('venues.index')} className="inline-block px-8 py-3.5 bg-accent hover:bg-accent-hover text-primary font-bold rounded-xl transition-all duration-200 hover:-translate-y-0.5 shadow-lg relative z-10">
                        Booking Sekarang 🚀
                    </Link>
                </div>
            </div>
